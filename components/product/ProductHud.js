...
export const ProductHud = ({ display, fetching, setValuesSelected }) => {
  //just on page render
    ...
    <Row className="text_dark w-100 justify-content-center ">
      ...
      <Row className="d-inline product_modele_desc_details justify-content-center">
        <Carousel activeIndex={display} controls={false}>
          ...
          <Carousel.Item>{!fetching ? <ProductOptions setValuesSelected={setValuesSelected} /> : "Chargement des options du produit"} </Carousel.Item>
        </Carousel>
      </Row>
