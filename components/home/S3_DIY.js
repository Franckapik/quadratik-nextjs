        ...
        <Row className="s3_diy_bg justify-content-center align-items-center p-2 p-md-5">
          <Col md={6} className="d-flex flex-column s3_diy_guide_text  order-md-last ">
            ...
            <Row className="d-flex s2_hor_swipe s3_diy_swipe flex-nowrap p-md-0 align-items-center text-center">
              ...
              <Col>
                <img onMouseOver={() => setExplanation(1)} src="./s3_guide_i1.png" style={{ opacity: explanation === 1 ? 1 : 0.1 }}></img>
              </Col>

              <Col>
                <img onMouseOver={() => setExplanation(2)} src="./s3_guide_i2.png" style={{ opacity: explanation === 2 ? 1 : 0.1 }}></img>
              </Col>

              <Col>
                <img onMouseOver={() => setExplanation(3)} src="./s3_guide_i3.png" style={{ opacity: explanation === 3 ? 1 : 0.1 }}></img>
              </Col>

              <Col>
                <img onMouseOver={() => setExplanation(4)} src="./s3_guide_i4.png" style={{ opacity: explanation === 4 ? 1 : 0.1 }}></img>
              </Col>
              <div className="s3_arrow d-flex d-md-none justify-content-center align-items-center h-100">
