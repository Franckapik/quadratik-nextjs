...
export const PerformancesCard = ({ product }) => {
  return (
    <>
      {product.dimensions.D === "D1" ||
        (product.dimensions.D === "D2" && (
      ...
      {product.dimensions.F !== undefined && (
        <Col className="flex flex-column ">
                    <PerformanceWidget icon="fad fa-bolt fa-xs" value={`${product.frequencies.fmax} Hz `} color="#f26565" performance={(product.frequencies.fmax * 100) / 1000} tooltip={"La plage de fréquence traitée"} /> {/* 10k audio frequency */}
