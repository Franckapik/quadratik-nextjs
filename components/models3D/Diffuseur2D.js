    ...
    <>
      ...
      {Array(n) //cellules
        ...
        .map((a, i) => {
          ...
          return (
            <group>
              <Cell key={"Cell" + i} args={[c + e, c, e]} position={[x, z, y === d ? y - e : y + e]} rotation={[0, 0, 0]} index={i} motif={C} color={y === 0 ? "blue" : LightenDarkenColor("#012000", (y * 355) / d)} highlights={highlights} teinte={T} />
              <Text
                color="black" // default
